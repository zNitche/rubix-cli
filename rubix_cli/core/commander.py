...
class Commander:
    ...
    #     self._logger.info(f"flashing '{root_path}'")

    #     if os.path.isfile(root_path):
    #         raise Exception(f"{root_path} should point to directory")

    #     self._logger.info("purging...")
    ...
    #     self._logger.info(message="purged, flashing...")
    ...
    #             path = f"{root}/{dirname}"
    #             self._logger.info(message=f"creating {path} directory...")
    ...
    #             self._logger.info(message=f"flashing {path}...")
