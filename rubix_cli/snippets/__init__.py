from rubix_cli.snippets.snippet_base import SnippetBase

from rubix_cli.snippets.snippet_ls import SnippetLs
from rubix_cli.snippets.snippet_rm import SnippetRm
